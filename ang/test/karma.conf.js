...
module.exports = (config) => {
  ...
  const extPath = cv('path -x uk.co.compucorp.certificate')[0].value;
  ...
  config.set({
    ...
    files: [
      ...
      // Source Files
      `${extPath}/ang/certificate.js`,
      { pattern: `${extPath}/ang/certificate/**/*.js` },
      ...
      { pattern: `${extPath}/ang/test/certificate/**/*.js` }
    ],
    exclude: [
    ],
    reporters: ['progress'],
